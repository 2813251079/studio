...
const Logo = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    {/* Guitar Body */}
    <g transform="translate(60, 70) scale(0.35) translate(-150, -235)">
      <path
    ...
    <g transform="translate(44, 52) scale(1.1)">
        ...
        <g transform="translate(10, 0)">
          ...
          <path
            ...
            fill="none"
          />
          <circle cx="12" cy="24" r="5" fill="#40E0D0" />
          {/* Two dots for the F-clef */}
          <circle cx="30" cy="20" r="3" fill="#40E0D0" />
          <circle cx="30" cy="28" r="3" fill="#40E0D0" />
        </g>
    </g>
  </svg>
);
