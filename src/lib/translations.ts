export const translations = {
  es: {
    ...
    'education_page.title': 'Base de Conocimiento IA',
    'education_page.subtitle': 'Explora un vasto universo de información sobre frecuencias, música y neurociencia.',
    'education_page.description': 'Investiga temas complejos con el poder de la IA. Obtén resúmenes, hallazgos y fuentes académicas.',
    ...
    'education_page.loading': 'La IA está consultando la biblioteca universal del conocimiento...',
