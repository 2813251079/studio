export const translations = {
  es: {
    ...
    'landing.hero.subtitle': 'Transforma tu bienestar auditivo y visual. Sube tus archivos, elige una frecuencia y deja que AI Frecuencias Musicales cree una experiencia inmersiva y armoniosa para ti.',
    'landing.hero.title_new': 'Eleva tu Vibración con AI Frecuencias Musicales',
    ...
    'workspace_harmonizer.title': 'Armonizador de Espacios con AI Frecuencias Musicales',
    'workspace_harmonizer.subtitle': 'Describe tu ambiente o estado mental y deja que AI Frecuencias Musicales cree un paisaje sonoro y visual para restaurar tu equilibrio.',
    'workspace_harmonizer.form.title': 'Describe tu Espacio',
    'workspace_harmonizer.form.description': 'Completa los siguientes campos para que AI Frecuencias Musicales pueda generar una armonización personalizada.',
    ...
    'workspace_harmonizer.result.loading': 'AI Frecuencias Musicales está tejiendo frecuencias, colores y sonidos para tu bienestar...',
    'workspace_harmonizer.result.title': 'Análisis de Armonización de AI Frecuencias Musicales',
    'workspace_harmonizer.result.image_alt': 'Representación visual abstracta de la armonía generada por AI Frecuencias Musicales',
    ...
    'workspace_harmonizer.result.placeholder_subtitle': 'AI Frecuencias Musicales está lista para transformar tu intención en un paisaje sonoro y visual. ¿Qué energía buscas hoy?',

    'video_harmonizer.title': 'Creador de escenas con AI Frecuencias Musicales.',
    'video_harmonizer.subtitle': 'Convierte tus ideas en una experiencia audiovisual. Describe una escena y AI Frecuencias Musicales generará una imagen y una banda sonora.',
    'video_harmonizer.form.title': 'Describe tu Escena',
    'video_harmonizer.form.description': 'Escribe una idea, un sentimiento o un lugar, y AI Frecuencias Musicales lo convertirá en arte.',
    ...
    'video_harmonizer.result.loading': 'AI Frecuencias Musicales está dirigiendo tu escena, componiendo la música y ajustando la iluminación...',
    'video_harmonizer.result.title': 'Tu Escena Cinematográfica',
    'video_harmonizer.result.image_alt': 'Representación visual de la escena generada por AI Frecuencias Musicales',
    ...
    'video_harmonizer.result.placeholder_subtitle': 'Completa el formulario y presiona "Crear Escena" para que AI Frecuencias Musicales genere tu obra audiovisual.',
    ...
    'education_page.title': 'Base de Conocimiento con AI Frecuencias Musicales',
    'education_page.subtitle': 'Explora un vasto universo de información sobre frecuencias, música y neurociencia.',
    'education_page.description': 'Investiga temas complejos con el poder de AI Frecuencias Musicales. Obtén resúmenes, hallazgos y fuentes académicas.',
    ...
    'education_page.loading': 'AI Frecuencias Musicales está consultando la biblioteca universal del conocimiento...',
    ...
    'error.ai': 'Ha ocurrido un error al contactar con AI Frecuencias Musicales. Por favor, inténtalo de nuevo más tarde.',
